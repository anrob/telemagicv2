  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved client as @client" do
        ...
        post :create, {:client => { "first_name" => "invalid value" }}, valid_session
        assigns(:client).should be_a_new(Client)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested client" do
        ...
        Client.any_instance.should_receive(:update_attributes).with({ "first_name" => "MyString" })
        put :update, {:id => client.to_param, :client => { "first_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the client as @client" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Client.any_instance.stub(:save).and_return(false)
        put :update, {:id => client.to_param, :client => { "first_name" => "invalid value" }}, valid_session
        assigns(:client).should eq(client)
      end
